        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ArLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Late = table.Column<double>(type: "float", nullable: false),
                    Long = table.Column<double>(type: "float", nullable: false),
                    EventDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EventTicket = table.Column<int>(type: "int", nullable: false),
